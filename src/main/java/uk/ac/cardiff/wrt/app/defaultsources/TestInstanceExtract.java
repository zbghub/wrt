...
//            processor.close();
            ...
            InstanceExtract processor = new InstanceExtract(OUTPUT_RESULT_OPTION, INPUT_ENTITY_OPTION);
            MyHelpers.processEntitiesFromWikidataDump(INPUT_WIKIDATA_OPTION, processor);
            processor.close();
