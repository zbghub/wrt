...
public class TestTripleExtractLabel {

    public static String INPUT_WIKIDATA_OPTION = "/Users/ziedbouraoui/Flexilog/wikidata/wikidata-20180604-all.json.gz";
    
    public static String INPUT_ENTITY_OPTION ="Q41176";
    
    public static String OUTPUT_RESULT_OPTION ="/Users/ziedbouraoui/GoogleDrive/data_rana/Q41176_building";
    
    public static String INPUT_WIKIID_OPTION ="/Users/ziedbouraoui/GoogleDrive/data_rana/Q41176_building/triples.csv";
