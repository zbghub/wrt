...
public class SubClassesExtract implements EntityDocumentProcessor {
    ...
    public  SubClassesExtract(String resultPath, String entityValueName) throws IOException {
        this.entityValue =  Datamodel.makeWikidataItemIdValue(entityValueName); 
        out = new PrintStream(MyHelpers.openExampleFileOuputStream(resultPath, "subclasses.csv"));
